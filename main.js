...
postPil.prototype.events = function () {
    ...
    this.form.addEventListener('submit', function (e) {
        ...
        if (/^\d+$/.test(no) && /\S/.test(no)) {
            ...
            var url = 'https://www.mobileads.com/api/save_lf?contactEmail=dickale@imx.co.id,karima@imx.co.id,adhie@mobileads.com,jeff@mobileads.com&gotDatas=1&element=[{%22fieldname%22:%22text_1%22,%22value%22:%22'+no+'%22}]&user-id=2901&studio-id=226&tab-id=1&trackid=2089&referredURL=Sample%20Ad%20Unit&callback=leadGenCallback'
